/*
 * $Id: DpmConfig.java,v 1.1 2007/03/27 12:52:22 marcoz Exp $
 *
...
import org.esa.beam.bop.meris.brr.auxdata.AuxFileInfo;
...
public class DpmConfig {
    ...
    public DpmConfig(String configFileName) throws DpmConfigException {
        auxdata = new Auxdata(AlbedomapConstants.SYMBOLIC_NAME, AUXDATA_DIRNAME);
        try {
            auxdata.installAuxdata(this);
        } catch (IOException e) {
            throw new DpmConfigException("Could not install auxdata", e);
        }
        File configFile = new File(auxdata.getDefaultAuxdataDir(), configFileName);
    ...
    public File getAuxDataDir() throws DpmConfigException {
        ...
        if (auxDataDirPath != null) {
            ...
            auxDataDir = auxdata.getDefaultAuxdataDir();
        }
        return auxDataDir;
    }
