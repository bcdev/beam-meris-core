/*
 * $Id: L2AuxData.java,v 1.1 2007/03/27 12:52:22 marcoz Exp $
 *
...
public final class L2AuxData implements Constants {
    ...
    private void loadConfigurationAuxData(final AuxFile auxFileO) throws IOException {
        ...
        if (startTime != null && stopTime != null) {
            ...
            seasonal_factor = AlbedoUtils.computeSeasonalFactor(daysSince2000,
